...
var garageOpenIcon = "<svg xmlns='http://www.w3.org/2000/svg' width='48' height='48' viewBox='0 0 24 24'><rect x='2' y='6' width='20' height='12' rx='1' fill='none' stroke='currentColor' stroke-width='1.5'/><rect x='4' y='2' width='16' height='4' rx='1' fill='currentColor'/><rect x='6' y='10' width='12' height='2' fill='currentColor' opacity='0.9'/></svg>";
var garageClosedIcon = "<svg xmlns='http://www.w3.org/2000/svg' width='48' height='48' viewBox='0 0 24 24'><rect x='2' y='6' width='20' height='12' rx='1' fill='currentColor'/><rect x='6' y='9' width='12' height='2' fill='white' opacity='0.15'/><circle cx='18' cy='15' r='1.2' fill='#ff5252'/></svg>";
                        ...
                        if (floorEntities[i].length < 4) {
                            ...
                            switch (floorEntities[i][3]) {
                                ...
                                case "door":
                                    ...
                                    break;
                                case "garage":
                                    newIcon.innerHTML = garageOpenIcon;
                                    break;
                                default:
                                    newIcon.innerHTML = binarySensorDefaultOn;
                            }
                        ...
                        if (floorEntities[i].length < 4) {
                            ...
                            switch (floorEntities[i][3]) {
                                ...
                                case "door":
                                    ...
                                    break;
                                case "garage":
                                    newIcon.innerHTML = garageClosedIcon;
                                    break;
                                default:
                                    newIcon.innerHTML = binarySensorDefaultOff;
                            }
...
function loadContentSwitches(entity_id) {
    ...
    if (Object.prototype.toString.call(apiData) === "[object Array]") {
        ...
        for (var i = 0; i < numRows; i++) {
            ...
            for (var j = 0; j < 5; j++) {
                ...
                if (index < switches.length) {
                    ...
                    var cellContent = switches[index]['attributes']['friendly_name'] + " ";
        ...
        var cellContent = apiData['attributes']['friendly_name'] + " ";
